...
definition(
    ...
    namespace: "",
    author: "James Clark",
    description: "If you have multiple presence devices per person and if at least one of the devices per person is preson or not preson. This app will change the phrase.",
